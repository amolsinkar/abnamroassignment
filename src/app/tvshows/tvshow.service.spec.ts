...
describe('TvshowService', () => {
  ...
  it('unit test setTvshowsSearch', () => {
    service.setTvshowsSearch('testSearch');
    expect(service.setTvshowsSearch).toBeDefined();
  });

  it('unit test getTvshowsSearch', () => {
    service.getTvshowsSearch();
    expect(service.getTvshowsSearch).toBeDefined();
  });
});
